...
const pickForm = (l) => ({
  ...
  quarterly_fee: l.quarterly_fee||0, annual_fee: l.annual_fee||0, exam_fee: l.exam_fee||0,
...
export default function Levels() {
  ...
  const submit = async (e) => {
    ...
    try {
      const payload = { ...form };
      ["duration_months","sessions_per_week","admission_fee","monthly_fee","quarterly_fee","annual_fee","exam_fee","material_fee","late_penalty"]
